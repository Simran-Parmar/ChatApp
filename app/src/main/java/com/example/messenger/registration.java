...
public class registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rg_repassword=findViewById(R.id.rgrePassord);
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                ...
                                if(imageURI!=null){
                                                        ...
                                                        reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                if(task.isSuccessful()){
                                                                    ...
                                                                    Toast.makeText(registration.this,"error in creating th user",Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                                        });
                                                    }
                                    ...
                                    String status="hey i'm using this app";
                                    imageuri="https://firebasestorage.googleapis.com/v0/b/messenger-77a81.appspot.com/o/man.png?alt=media&token=d59784bb-18b9-4039-866c-2a76f6a1d652";
